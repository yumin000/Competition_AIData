...
def feature_engineering(df, target_col, rain_col):
    ...
    df_copy[f'{rain_col}_rolling_sum_15_shifted'] = df_shifted[rain_col].rolling(window=15).sum()
...
final_df = feature_engineering(df, TARGET_COLUMN, RAIN_COL)
